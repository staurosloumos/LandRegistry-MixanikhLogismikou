...
/**
 * Insert Record to the database from this dialog form.
 * 
 */
public class InsertRecord extends javax.swing.JDialog {
    // Create an instance of the sap connection.
    private Connection dbConn;
    private Main parentFrame;
    /** Creates new form login */
    public InsertRecord(Window owner, Connection _dbConn, Main frm) {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Εισαγωγή κτηματολογικών στοιχείων:");
